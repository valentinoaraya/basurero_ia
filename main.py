...
camera = cv2.VideoCapture("rtsp://admin:FaNaVa041214AEd+@192.168.1.108:554/cam/realmonitor?channel=1&subtype=1")
...
while True:
    ...
    if ret:
        preview = cv2.resize(frame, (224, 224), interpolation=cv2.INTER_AREA)
        cv2.imshow("Detector de basura", preview)
        ...
        if message == "START":
            ...
            while time.time() - start_time < 3:
                ...
                if confidence_score > 0.90:
                    ...
                    print(class_name, round(confidence_score * 100, 2))
